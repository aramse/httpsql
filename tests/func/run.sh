...
curl --fail -v -X POST -d '[{"id": 1, "first_name": "Dustin", "last_name": "Hoffman", "grade": 8}]' api/tables/students
curl --fail -v -X POST -d '[{"id": 2, "first_name": "Rick", "last_name": "Sanchez", "grade": 9}, {"id": 3, "first_name": "Morty", "last_name": "Smith", "grade": 10}]' api/tables/students
...
curl --fail -v -X DELETE 'api/tables/students?fName=id&fValue=1'
